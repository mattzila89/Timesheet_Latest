...
extern void *mono_aot_module_LoginNavigationiOS_info;
...
extern void *mono_aot_module_LoginNavigation_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_LoginNavigationiOS_info);
	...
	mono_aot_register_module (mono_aot_module_LoginNavigation_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "LoginNavigationiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
